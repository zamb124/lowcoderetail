...
if __name__ == "__main__":
    ...
    logger.warning("taskiq worker purchase.app.worker:broker --reload --fs-discover --on-startup purchase.app.worker:startup --on-shutdown purchase.app.worker:shutdown")