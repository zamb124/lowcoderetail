...
from fastapi import Request, Depends, Path as FastAPIPath # Используем FastAPIPath во избежание конфликта
import uuid
...
async def get_view_mode_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, item_id, RenderMode.VIEW)
...
async def get_edit_form_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, item_id, RenderMode.EDIT)
...
async def get_create_form_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, None, RenderMode.CREATE)
...
async def get_list_mode_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, None, RenderMode.LIST)
...
async def get_list_rows_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, None, RenderMode.LIST_ROWS)
...
async def get_table_cell_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, item_id, RenderMode.TABLE_CELL, field_to_focus=field_name)
...
async def get_inline_edit_field_renderer(
    ...
    return await get_renderer(request, model_name, dam_factory, user, item_id, RenderMode.EDIT, field_to_focus=field_name)
...
async def get_filter_form_renderer( # Новая специализированная зависимость
    ...
    return await get_renderer(request, model_name, dam_factory, user, None, RenderMode.FILTER_FORM)