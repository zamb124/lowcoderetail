...
def mount_static_files(app: FastAPI):
    ...
    try:
        ...
        logger.info(f"SDK static files mounted at '{STATIC_URL_PATH}' from directory '{STATIC_DIR}'.")
    except Exception as e:
        logger.exception(f"Failed to mount SDK static files from '{STATIC_DIR}' at '{STATIC_URL_PATH}'.")
