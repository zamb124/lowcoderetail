...
import uuid
import json
from typing import List, Dict, Any, Optional, Union, Literal, Mapping, TypeVar # Добавил TypeVar
...
from core_sdk.filters.base import DefaultFilter # Импортируем DefaultFilter
